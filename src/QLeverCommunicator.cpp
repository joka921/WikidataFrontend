...
std::string QLeverCommunicator::replaceEntitiesInQLeverResult(const std::string &jsonQlever,
  ...
  return  "{\"status\":\"ERROR\", \"exception\":\"Error while parsing json from QLever Backend\"}";
}
